...
const AdminProjects = () => {
  ...
  return (
    <div style={{color:'white'}} className="all-projects-page">
      ...
      <div style={{color:'white'}} className="projects-list">
        ...
        {displayprojects.map((project)=>(
            ...
            <div className="listed-project" key={project._id}  >
              ...
              <h5 style={{color:'white'}}>Budget &#8377; {project.budget}</h5>
              <h5 style={{color:'white'}}>Client name: {project.clientName}</h5>
              <h5 style={{color:'white'}}>Client email: {project.clientEmail}</h5>
              ...
              <h5 style={{color:'white'}}>Status - {project.status}</h5>
              <hr />
            </div>
        ))}
